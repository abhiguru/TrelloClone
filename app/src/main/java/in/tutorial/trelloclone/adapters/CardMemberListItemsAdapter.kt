...
import `in`.tutorial.trelloclone.databinding.ItemCardSelectedMemberBinding
...
open class CardMemberListItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return CardMemberListItemsAdapter.MyViewHolder(ItemCardSelectedMemberBinding.inflate(
